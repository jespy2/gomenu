...
import { Dish } from "../../components/ratings-display/Dish";
...
export const TextInput = ({
	label,
	...props
}: IOtherProps & FieldHookConfig<string>) => {
...
export const RatingInput = ({
	currValue,
	...props
}: ICurrValue & FieldHookConfig<string>) => {
	let component = [];
	for (let i = 1; i <= 5; i++) {
